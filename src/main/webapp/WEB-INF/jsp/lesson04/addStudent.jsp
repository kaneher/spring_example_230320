...
<body>
	<div class="container">
		...
		<form method="post" action="/lesson04/ex02/add_student">
			...
			<div class="form-group">
				<label for="phoneNumber"><b>폰번호</b></label>
				<input type="text" id="phoneNumber" name="phoneNumber" class="form-control col-3" placeholder="휴대폰 번호를 입력해주세요">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" id="dreamJob" name="dreamJob" class="form-control col-3" placeholder="장래희망을 입력해주세요">
			</div>
